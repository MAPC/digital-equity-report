  ...
  return (
    <div>
      <div className="section">
        ...
        <p>MAPC is very grateful to the community advisory teams that met throughout this planning process to provide feedback and respond to proposed strategies and data analysis. The groups were extremely helpful in distributing and completing of the community needs assessment. It provided perspective that informed the plan's vision and goals, and shaped the focus and framing of this report. Ultimately, it will be this set of stakeholders that will implement the goals of the plan.</p>
        <AnchorLink 
          to={`#appendix`} 
          className="anchor"
        >
