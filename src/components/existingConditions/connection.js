...
import chart3 from "../../images/race.png";
import chart4 from "../../images/smartphone.png";
  ...
  return (
    <div>
      <div className="section">
        <h3>Connection and Access</h3>
        <h4>Communities at a Glance</h4>
      ...
      <div className="section">
        ...
        <iframe src="https://public.tableau.com/views/FCC_DA_Munis/TechnologyTableDashboard?:showVizHome=no&:embed=true" width="100%" height="828"></iframe>
