  ...
  return (
    <div>
      <div className="section">
        ...
        <iframe src="https://public.tableau.com/views/ACSPercentofHouseholdswithoutInternet/U_S_CensusQuestions?:showVizHome=no&:embed=true" width="100%" height="600"></iframe>
        ...
        <iframe src="https://public.tableau.com/views/ACSPercentofHouseholdswithSmartphoneOnly/U_S_CensusQuestions?:showVizHome=no&:embed=true" width="100%" height="600"></iframe>
        <p className="citation">American Community Survey 2019 5 year: Table S2801.</p>
